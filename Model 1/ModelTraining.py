...
import os
import json  # Import json for saving tokenizer indices

# Function to save tokenizer index
def save_word_index(filepath, word_index):
...
save_word_index('diet_tokenizer_word_index.json', tokenizer.word_index)
...
# Save the label tokenizer index
save_word_index('diet_label_tokenizer_word_index.json', label_tokenizer.word_index)
